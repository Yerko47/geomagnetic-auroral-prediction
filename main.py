...
def main():
    ...
    for delay in delay_length:
        ...
        #* Training Model
        model, metrics_df = train_val_model(model, criterion, optimizer_type, train_loader, val_loader, EPOCH, lr, delay, type_model, auroral_index, schler, patience_schler, patience, device, model_file)
...
#        result_df, metric_test = model_testing(model, criterion, test_loader, model_file, type_model, auroral_index, test_epoch, #device)
...
#
#        delays_plot.append(delay)
#
#        delay_metrics_plot(metric_test_delay, delays_plot, auroral_index, type_model, test_loss_file, test_r_score_file, #test_d2_abs_file, test_d2_tweedie_file)
#
